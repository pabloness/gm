...
$(function(){
    ...
    readTextFile("../config.json",function(text){
        ...
        //rechargeStatis(GetCookies("token"),pf_0,sid_0,ctype_0,begintime_0,endtime_0);
    });
    tablebody(5);
    ...
    document.getElementById('searchbtn').onclick = function(){
        ...
        rechargeStatis(GetCookies("token"),pf,sid,ctype,begintime,endtime);
    }
})

function rechargeStatis(CS_token,CS_pf,CS_sid,CS_ctype,CS_beginDate,CS_endDate){
    if(!GetCookies("token")){
        // alert("账号已过期，请重新登陆");
        window.location.href = "login.html";
        return;
    ...
    httpRequest.open('POST', httpHead+ IPconf + ':' + prot + '/statistics15',true);
