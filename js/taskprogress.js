...
$(function (){
    ...
    readTextFile("../config.json",function(text){
        ...
        //statistics10(GetCookies("token"),ctype_0,pf_0,sid_0,begintime_0,endtime_0);
    });
    tablebody(2);
    ...
    document.getElementById('searchbtn').onclick = function(){
        ...
        statistics10(GetCookies("token"),ctype,pf,sid,begintime,endtime);
    }
})

function statistics10(CS_token,CS_ctype,CS_pf,CS_sid,CS_beginDate,CS_endDate){
    if(!GetCookies("token")){
        // alert("账号已过期，请重新登陆");
        window.location.href = "login.html";
        return;
    ...
    httpRequest.open('POST', httpHead+ IPconf + ':' + prot + '/statistics10',true);
